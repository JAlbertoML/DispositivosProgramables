; RESTAR DOS CANTIDADES DE TRES BITS QUE INGRESAN POR EL PUERTO A Y EL RESULTADO SALE POR EL PUERTO B
    ...
    #DEFINE RESTA   H'12' ; SE ASIGNÓ LA DIRECCIÓN 18 DEL BANCO INDEFINIDO AL REGISTRO RESTA
